...
#         return False
# Used to require this for database lookups, but now I'm filtering based on current logged in user, so if loggedin user is not the owner QS will return 404
